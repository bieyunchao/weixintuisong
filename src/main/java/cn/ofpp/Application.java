...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // new 一个 女友
        GirlFriend girlFriend = new GirlFriend("小彭护士",
                "河南省", "新乡市", "2000-01-30", "2022-07-29", "o8pus56iM19bMntcCN8bDXXEH8_I");
        Wx.sendTemplateMessage(MessageFactory.resolveMessage(girlFriend));
        BoyFriend boyFriend = new BoyFriend("别云超","河南省","安阳市","2003-05-28","2022-07-29","o8pus58AT_A0EpHu98MKZ3EKYmmY");
